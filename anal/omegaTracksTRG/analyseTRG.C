...
void analyseTRG(TString dataFilename = "dataTRG/559609/AO2D.root", TString mcFilename = "mcMB/AO2D.root", TString normalisationFilename = "dataTRG/559609/AnalysisResults.root")
{
  ...
  uint32_t toiHM = 1;
  uint32_t toiTO = 0x40;
  float normHM = 0.8/100.;
  //double normalisations[2]{0.7558 / zorroSummary->getNormalisationFactor(0) / 0.857, 0.7558 /zorroSummary->getNormalisationFactor(0)};
  //                                       Tracked                                            Nontracked
  double normalisations[2]{0.7558 / zorroSummary->getNormalisationFactor(1) / 0.857/0.001, 0.7558 /zorroSummary->getNormalisationFactor(0)/ normHM };
