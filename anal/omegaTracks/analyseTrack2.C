...
void analyseTrack2(TString dataFilename = "dataMB/AO2D.root", TString mcFilename = "mcMB/AO2D.root", TString normalisationFilename = "dataMB/AnalysisResults.root")
{
