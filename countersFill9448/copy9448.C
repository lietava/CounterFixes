...
void copy9448() {
  ...
  //apiProd.setURL("http://alice-ccdb.cern.ch");
  //o2::ccdb::CcdbApi apitest;
  //apitest.init("http://ccdb-test.cern.ch:8080");
  // read
  o2::ccdb::CcdbApi apiTest;
  apiTest.init("http://ccdb-test.cern.ch:8080");
  //o2::ccdb::BasicCCDBManager& apiTest = o2::ccdb::BasicCCDBManager::instance();
  //apiTest.setURL("http://ccdb-test.cern.ch:8080");
  int ic = 0;
  for (int runNb : runNbVect) {
    ...
    //auto cfg = apiTest.getSpecific<o2::ctp::CTPConfiguration>(ccdbConfig, tstart, metadata);
